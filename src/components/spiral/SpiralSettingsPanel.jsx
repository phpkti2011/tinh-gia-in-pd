...
export default function SpiralSettingsPanel({ config, onSave, onSaved, onCancel }) {
    ...
    const {
        ...
        saveLocal: saveSpiralConfig,
        onSave,
        onSaved,
        invalidMessage: 'Cấu hình sổ lò xo không hợp lệ, không lưu. Mở Console để xem lỗi.',
    });
